...
function SidebarProvider({
  ...
  // Este é o estado interno da sidebar.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Isso define o cookie para manter o estado da sidebar.
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
    },
    [setOpenProp, open],
  )

  // Helper para alternar a sidebar.
  ...
  // Isso facilita o estilo da sidebar com classes Tailwind.
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Isso é o que lida com o espaçamento da sidebar no desktop */}
      <div
      ...
      <div
        ...
        className={cn(
          ...
          // Ajusta o padding para variantes floating e inset.
          variant === "floating" || variant === "inset"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Aumenta a área de toque do botão no mobile.
